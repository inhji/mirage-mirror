defmodule WebmentionsTest do
  ...
  alias Mirage.Indie.Webmentions

  doctest Mirage.Indie.Webmentions
  ...
  describe "Webmentions.discover_endpoint/1" do
    test "discovers from a link in header" do
      ...
      assert Webmentions.discover_endpoint("http://example.org") ==
               ...
               {:ok,
                [
                  %Webmentions.Response{
                    status: :no_endpoint,
                    target:
                      "http://images1.dawandastatic.com/Product/18223/18223505/big/1301969630-83.jpg",
                    endpoint: nil,
                    message: "no endpoint found"
                  }
                ]}
